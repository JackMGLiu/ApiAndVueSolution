...
namespace ApiApplication.AuthHelper
{
    public class MyToken
    {
        ...
        public static string IssueJWT(TokenModel tokenModel, TimeSpan expiresSliding, TimeSpan expiresAbsoulte)
        {
            ...
            JwtSecurityToken jwt = new JwtSecurityToken(
                issuer: "GeekFM.Core",//jwt签发者,非必须，自定义
            ...
            MyMemoryCache.AddMemoryCache(encodedJwt, tokenModel, expiresSliding, expiresAbsoulte);//将JWT字符串，令牌实体，存入缓存
            return encodedJwt;
        }
